  ...
  vi: {
    translation: {
      ...
      home: {
        ...
        fieldNoteBody: "Không điều gì ở đây cần trở thành một danh tính cố định trước khi có thể được quan sát.",
  ...
  ko: {
    translation: {
      ...
      home: {
        ...
        fieldNoteBody: "여기에서 관찰되는 어떤 것도 관찰되기 전에 고정된 정체성이 될 필요는 없습니다.",
