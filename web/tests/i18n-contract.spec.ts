...
const localizedHomeCopy = {
  en: {
    path: ".",
    label: "02 / Field note",
    evidence: "03 / Evidence before certainty",
    alt: "A field notebook with abstract contour-map sketches",
  },
  vi: {
    path: "vi",
    label: "02 / Ghi chép thực địa",
    evidence: "03 / Bằng chứng trước khi kết luận",
    alt: "Cuốn sổ thực địa với các phác thảo bản đồ đường đồng mức trừu tượng",
  },
  ko: {
    path: "ko",
    label: "02 / 현장 노트",
    evidence: "03 / 확신보다 근거",
    alt: "추상적인 등고선 지도 스케치가 있는 현장 노트",
  },
} as const;
...
test("i18n contract: Home field-note labels and image alternative text follow the active locale", async ({
  page,
}) => {
