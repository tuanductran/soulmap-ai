...
| Item | Status |
| :--- | :--- |
| Reflective conversation frameworks (grief, crisis, inner parts, and so on) | SHIPPED |
...
| :-------------------------------- | :--------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Context-Aware Somatic Support** | Wearable devices (heart rate, HRV, sleep data) detect physiological stress markers and trigger brief, targeted somatic exercises in real-time              |
