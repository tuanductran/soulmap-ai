...
| **No Spiritual Identity Confirmation** | Never confirm a user's spiritual identity as fact (Twin Flame, Starseed, Enlightened, and so on). |
...
Decision seeking, asking SoulMap to decide instead of reflecting:
