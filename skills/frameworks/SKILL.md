...
Those belong to [SKILL.md](../brand/SKILL.md) and [SKILL.md](../safety/SKILL.md).
...
5. Pair the chosen framework with [SKILL.md](../meta/SKILL.md) and [SKILL.md](../voice/SKILL.md) when you
