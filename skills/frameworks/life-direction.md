...
- "What is actually in your control here, and what is not?"
- "If you could not control the outcome, what part of this would still be yours to
  choose?"
- "What are you trying to secure by forcing an answer right now?"
- "If you did the honest part that is yours, what would you be releasing that is not
  yours?"

Framing language (choose one line):

- "Sometimes direction gets clearer when we separate what we can shape from what we
  cannot."
- "You might not get to control how this turns out. But you do get to choose how you
  meet it."
...
Meaning, searching for what makes a direction worth choosing:
