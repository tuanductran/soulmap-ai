...
### External frustration signals

Additional detection phrases (beyond the "sounds like" examples above) that mark this
as external-frustration territory rather than pattern-mapping territory:
