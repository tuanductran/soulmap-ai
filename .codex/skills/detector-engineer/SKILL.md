...
- Editing rules and conventions, refer to [`.codex/rules/detector-development.md`](../../rules/detector-development.md)
...
1. Read `.codex/rules/detector-development.md` before writing any code.
