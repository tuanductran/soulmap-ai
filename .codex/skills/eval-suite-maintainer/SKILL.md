...
- Modifying the core framework selection logic, use code editing tools directly and follow [`.codex/rules/detector-development.md`](../../rules/detector-development.md)
...
- `.codex/rules/evals-and-testing.md`, group structure conventions and schema
...
```bash
# Quick JSON check
python -c "import json; json.load(open('evals/groups.json'))"
