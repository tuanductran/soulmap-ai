...
Examples
--------
python -m tools.build_skill                  # zip build
python -m tools.build_skill --skill          # .skill build
...
def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(
        prog="python -m tools.build_skill",
        description="Build SoulMap AI distribution artifacts.",
        formatter_class=argparse.RawDescriptionHelpFormatter,
        epilog=textwrap.dedent("""\
            examples:
              python -m tools.build_skill           build the standard zip
              python -m tools.build_skill --skill   build the .skill package
        """),
    )
    parser.add_argument(
        "--skill",
