...
def _compose_response(
    ...
    if primary == "CRISIS":
        return (
            ...
            "or use findahelpline.com to find the right crisis line where you are. "
    ...
    if primary == "DEPENDENCY":
        return (
            ...
            "of people who can actually be with you offline. Is there someone you trust in real "
            "life you can reach out to today?"
        )
    ...
    if primary == "SYNTHESIS":
        return (
            "Across what you've shared, a few themes seem to keep returning. One is loneliness, "
            "especially the feeling of being with people and still somehow on your own. Another is "
            "a repeated tension between wanting connection and pulling away before disappointment can land. "
            "I might be missing something, but when you look at all of this together, what stands out most to you?"
        )
...
def main(argv: list[str] | None = None) -> int:
    _ = argv
    cases = _load_json(REPO_ROOT / "evals" / "response_generation_cases.json")
