...
- Remove private-source traces from founder-facing copy. Keep rewritten patterns only,
  never source names, raw excerpts, or identifying details.
- Prefer tightening existing wording over inventing new brand layers.
