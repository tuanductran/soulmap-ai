...
The catalog has seven entries: Brand, Core Frameworks, Safety Guardrails, Meta Guidance, Spiritual Layer, Voice System, and Soulmate Layer. Each entry points to one directory under `skills/`, while [`SKILL.md`](../../SKILL.md) and [`SOULMAP.md`](../../SOULMAP.md) remain the governing root documents.
