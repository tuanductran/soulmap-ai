...
Copy the full text from [chatgpt-instructions.md](integrations/chatgpt-instructions.md)
...
Copy the full text from [gemini-instructions.md](integrations/gemini-instructions.md)
and paste it into the instructions field.
...
Copy the full text from [poe-system-prompt.md](integrations/poe-system-prompt.md)
and paste it into the **System prompt** field.

### Step 3, set the intro message

Copy from [poe-system-prompt.md](integrations/poe-system-prompt.md) under
`## Intro message`.
