...
LOCALES: Final[dict[str, dict[str, str]]] = {
    "en": {
        ...
        "search_hint": "Results update as you type; press Enter to keep searching here.",
        "loading": "Loading…",
    ...
    "vi": {
        ...
        "search_hint": "Kết quả cập nhật khi bạn nhập; nhấn Enter để tiếp tục tìm ngay tại đây.",
        "loading": "Đang tải…",
